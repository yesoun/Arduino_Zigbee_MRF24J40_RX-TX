 ...
 * 1st versiopn for pavement marker project in UIDAHO with Arduino + Zigbee Microchip mrf24j40 module to send and receive color states + timing by sending packets using plain 802.15.4
